    ...
    <div className="space-y-8">
      ...
      <div className="bg-card rounded-lg shadow-soft border border-border p-6">
        ...
        <p className="text-muted-foreground">
          Manage your fitness club, members, classes, and subscriptions all in one place.
        </p>
      </div>
      ...
      <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
        <h2 className="text-lg font-semibold text-foreground mb-2">🎉 Welcome to ClubManager!</h2>
        <p className="text-muted-foreground mb-4">
          Let's get your fitness club set up. Here are the next steps to get started:
        </p>
